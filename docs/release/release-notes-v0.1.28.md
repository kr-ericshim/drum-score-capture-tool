...
- Release packaging is more robust across macOS and Windows, including frozen backend runtime checks, packaged smoke tests, CI test isolation, and Windows asar asset path handling.
...
```bash
xattr -dr com.apple.quarantine "/path/to/Drum.Sheet.Capture-0.1.28-arm64.dmg"
```
