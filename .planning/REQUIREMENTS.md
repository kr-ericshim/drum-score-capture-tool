...
- [ ] **EXP-01**: User can export the selected score as PDF and page images from the desktop app
- [ ] **EXP-02**: User can enter title, performer, date, BPM, and optional notes immediately before export
